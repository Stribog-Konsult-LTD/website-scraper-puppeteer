        ...
        registerAction('afterResponse', async ({response}) => {
            ...
            if (this.stayOnDomain) {
                ...
                if (url.indexOf(this.domain) == -1) {
                    ...
                    console.log("stayOnDomain::Blocked because leaving domain:", this.domain);
                    await blockNavigation(page, url);
                }

            }
            //eof dobrys
            console.log("afterResponse::finishing :",response.request.href);
            ...
            if (isHtml) {
                ...
                // Dobrys - Configure the navigation timeout
                ...
                if (this.blockNavigation) {
                    console.log("blockNavigation::Blocked urln:", url);
                    await blockNavigation(page, url);
                }
